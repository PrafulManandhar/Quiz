...
const keys = require("../../../../intern_user_management/config/keys");
const passport = require("passport");
const bcrypt = require("bcryptjs");
const validateLogin = require("../../../../intern_user_management/validator/validateLogin");
const validateAddUser = require("../../../../intern_user_management/validator/validateAddUser.js");
const validateAddCustomer = require("../../../../intern_user_management/validator/validateAddCustomer.js");
const validateUpdateUser = require("../../../../intern_user_management/validator/validateUpdateUser.js");
const validateUpdatePassword = require("../../../../intern_user_management/validator/validateUpdatePassword.js");
const validatePassword = require("../../../../intern_user_management/validator/validatePassword.js");
const Roles = require("../../../../intern_user_management/config/roles");
const SLUGS = require("../../../../intern_user_management/config/slugs");
const DYNAMIC_LEGENDS = require("../../../../intern_user_management/config/legends");
const SHIFTS = require("../../../../intern_user_management/config/shifts");
const Globals = require("../../../../intern_user_management/config/global");
const ResetValidation = require("../../../../intern_user_management/validator/resetValidation");
const databaseUtility = require("../../../../intern_user_management/utility/databaseUtility");
const checkPermission = require("../../../../intern_user_management/utility/checkPermission");
const pool = require("../../../../intern_user_management/config/pool").pool;
const Actions = require("../../../../intern_user_management/config/messages").Actions;
const Errors = require("../../../../intern_user_management/config/messages").Errors;
const Success = require("../../../../intern_user_management/config/messages").Success;
const transporter = require("../../../../intern_user_management/utility/mail");
const tokenExpiration = 36000;
const mailOptions = require("../../../../intern_user_management/config/mailOptions");
